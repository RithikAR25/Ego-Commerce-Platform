 ...
 *
 * <p>Consumed asynchronously by {@code NotificationEventListener.onOrderShipped()},
 * which dispatches the shipping confirmation email on the {@code ego-async-*} thread pool.
 */
public class OrderShippedEvent extends ApplicationEvent {
    ...
    public OrderShippedEvent(Object source, Long orderId, Long userId) {
        super(source);
